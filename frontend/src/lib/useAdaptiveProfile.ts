/**
 * useAdaptiveProfile — the single hook that drives every adaptive rendering decision.
 *
 ...
 *
 * Day-1 stub: returns a profile derived from localStorage + Me context.
 * Mid-point: real logic replaces the derivation, but the contract (AdaptiveProfile) stays identical.
 */
